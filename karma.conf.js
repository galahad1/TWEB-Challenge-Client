...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/animal/animalModule.js',
			'app/modules/animal/animalCtrl.js',
			'app/modules/animal/animalRoute.js',
			'app/modules/animal/animalService.js',
			'app/modules/animal/animal-test.js',
			'app/modules/champignon/champignonModule.js',
			'app/modules/champignon/champignonCtrl.js',
			'app/modules/champignon/champignonRoute.js',
			'app/modules/champignon/champignonService.js',
			'app/modules/champignon/champignon-test.js',
		],
